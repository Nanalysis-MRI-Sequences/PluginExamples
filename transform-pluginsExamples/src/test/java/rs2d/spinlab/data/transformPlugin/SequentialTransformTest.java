...
// * @author jb
// */
//public class SequentialTransformTest {
//
//    @Test
...
//        header1.getParam(DefaultParams.ACQUISITION_MATRIX_DIMENSION_1D.name()).setValue(Size1D);
//        header1.getParam(DefaultParams.ACQUISITION_MATRIX_DIMENSION_2D.name()).setValue(Size2D);
//        header1.getParam(MriDefaultParams.ACQUISITION_MATRIX_DIMENSION_3D.name()).setValue(Size3D);
//        header1.getParam(MriDefaultParams.ACQUISITION_MATRIX_DIMENSION_4D.name()).setValue(Size4D);
...
//        } catch (Exception ex) {
//            Logger.getLogger(InterleavedTransformTest.class.getName()).log(Level.SEVERE, null, ex);
//        }
//    }
...
//        int receiver = 0;
//
//        SequentialTransform instance = new SequentialTransform();
...
//
//        assertEquals("Test put data", 5, dataSet.getData(receiver).getRealPart()[0][0][2][1], 0.1f);
