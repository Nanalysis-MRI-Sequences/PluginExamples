...
// * @author jb
// */
//public class Interleaved3D_Sequential4DTransformTest {
//
//    public Interleaved3D_Sequential4DTransformTest() {
//    }
...
//        float[] dataReal = {1f, 2f, 3f, 4f, 5f, 6F, 7f, 8f, 9f, 10f, 11f, 12f, 13f, 14f, 15f, 16f};
//        float[] dataImaginary = {1f, 2f, 3f, 4f, 5f, 6F, 7f, 8f, 9f, 10f, 11f, 12f, 13f, 14f, 15f, 16f};
//
//
...
//        int receiver = 0;
//
//        Interleaved3DSequential4DTransform instance = new Interleaved3DSequential4DTransform();
//        instance.setDataset(dataSet);
////        for (int i = 0; i < Size2D/2; i++) {
//        instance.putData(dataReal, dataImaginary, 0, k, l, receiver);
//
//        float[] dataReal1 = new float[Size1D * etl * Size3D];
//        for (int i = 0; i < dataReal1.length; i++) {
//            dataReal1[i] = dataReal[i] + dataReal1.length;
//        }
//        instance.putData(dataReal1, dataImaginary, 1, k, l, receiver);
//
//
...
//
//        System.out.println("New 4D");
//        
//        System.out.println("");
//        soutMatrice(dataSet.getData(receiver).getRealPart()[1][0]);
//        System.out.println("");
//        soutMatrice(dataSet.getData(receiver).getRealPart()[1][1]);
//        System.out.println("");
//        soutMatrice(dataSet.getData(receiver).getRealPart()[1][2]);
//        System.out.println("");
//        soutMatrice(dataSet.getData(receiver).getRealPart()[1][3]);
//
////        System.out.println("");
